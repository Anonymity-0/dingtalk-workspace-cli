...
冻结基线：`origin/main@5f906bf8b61bc54a75f6c2b46219a1deb682b600`。本轮覆盖 42 个此前未进入正式参数兜底范围的公开 Shortcut，正式 `internal/cli/param_concepts.json` 未修改。
...
| DevApp | 6 | 4 | 6 | 22 | [报告](./devapp/devapp_cli_param_hallucination_analysis.md) | [候选表](./devapp/param_concepts.json) |
...
| Chat | 18 | 9 | 18 | 66 | [报告](./chat/chat_cli_param_hallucination_analysis.md) | [候选表](./chat/param_concepts.json) |
