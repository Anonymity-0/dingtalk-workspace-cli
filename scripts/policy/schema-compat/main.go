...
// property that agents bind against. ding pilot: Execute/CallMCP keys are the
// ground truth (see internal/shortcut/ding/ding.go).
var reviewedPropertyCorrections = []reviewedPropertyCorrection{
	{
		toolPath:    "ding/ding.shortcut_receiver_status",
		param:       "ding-id",
		oldProperty: "dingId",
		newProperty: "openDingId",
	},
	{
		toolPath:    "ding/ding.shortcut_recall_personal",
		param:       "id",
		oldProperty: "id",
		newProperty: "openDingId",
	},
	{
		toolPath:    "ding/ding.shortcut_send_personal",
		param:       "users",
		oldProperty: "users",
		newProperty: "receiverOpenDingTalkIds",
	},
	{
		toolPath:    "ding/ding.shortcut_send_personal",
		param:       "type",
		oldProperty: "type",
		newProperty: "remindType",
	},
}
