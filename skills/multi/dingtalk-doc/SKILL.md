---
name: dingtalk-doc
description: 钉钉在线文档(adoc)：查找/创建/读写/信息/编辑/块/评论/附件/媒体/白板/导入导出(docx/markdown/pdf)/版本/模板/权限/分享/Markdown/JSONML。文件→dingtalk-drive；知识库→dingtalk-wiki；原生.md/axls→dingtalk-misc；able→dingtalk-aitable。命令:dws doc。
metadata:
  cli_version: ">=0.2.14"
  category: product
  requires:
