...
> 产品命令见 [contact.md](./contact.md)。通用批量/并行见 [recipes/shared/conventions.md](recipes/shared/conventions.md)。
...
- **批量**：多个 `userId` 用 `contact user get --ids id1,id2,...`；多部门成员列表按需并行，遵守单次批量上限与 [recipes/shared/conventions.md](recipes/shared/conventions.md)。
