...
| 管理普通文件全局评论 | `dws drive comment list/create/reply/update/delete/batch-query/list-replies/resolve/restore/react-reply` | 复用 Doc/Sheet 新评论链路；固定全文 `global`，不支持划词、单元格或 mention |
