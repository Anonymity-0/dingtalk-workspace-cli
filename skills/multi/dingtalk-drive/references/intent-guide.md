...
| PDF、DOCX、XLSX 等普通文件的评论查询或生命周期操作 | Drive `comment list/create/reply/update/delete/batch-query/list-replies/resolve/restore/react-reply` | Doc/Sheet comment | 普通文件固定使用文件级 global topic，不支持划词或单元格锚点 |
