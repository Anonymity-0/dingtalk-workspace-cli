...
func TestMinutesP0ConfirmationPolicyReachesFinalSchema(t *testing.T) {
	wants := []finalSchemaSafetyWant{
		{canonical: "minutes.update_minutes_title", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.record_start", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.record_pause", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.record_resume", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.record_stop", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.update_minutes_summary", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.replace_speaker", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.delete_personal_hotword", effect: "destructive", risk: "high", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.replace_minutes_text", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.add_member_permission", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.remove_member_permission", effect: "destructive", risk: "high", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.apply_minutes_permission", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		...
		{canonical: "minutes.shortcut_upload", effect: "write", risk: "medium", confirmation: "not_required", idempotency: "unknown"},
		{canonical: "minutes.shortcut_upload_and_notify", effect: "write", risk: "medium", confirmation: "user_required", idempotency: "unknown"},
		{canonical: "minutes.shortcut_upload_and_analyze", effect: "write", risk: "medium", confirmation: "not_required", idempotency: "unknown"},
		{canonical: "minutes.shortcut_mindmap", effect: "write", risk: "medium", confirmation: "not_required", idempotency: "unknown"},
		{canonical: "minutes.shortcut_speaker_insights", effect: "write", risk: "medium", confirmation: "not_required", idempotency: "unknown"},
		{canonical: "minutes.shortcut_prepare_asr", effect: "write", risk: "medium", confirmation: "not_required", idempotency: "idempotent"},
		{canonical: "minutes.shortcut_sync_asr", effect: "destructive", risk: "high", confirmation: "user_required", idempotency: "idempotent"},
		{canonical: "minutes.shortcut_unshare", effect: "destructive", risk: "high", confirmation: "user_required", idempotency: "unknown"},
	}
	assertFinalSchemaSafety(t, wants)
}
