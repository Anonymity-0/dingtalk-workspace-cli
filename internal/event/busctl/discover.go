...
// persistent bus metadata; Unix sockets live under os.TempDir so WorkDir may
// reside on a shared filesystem without socket support. The caller must mkdir
// WorkDir with pkg/config.DirPerm beforehand.
