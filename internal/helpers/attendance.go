	...
	DeclareLeafMetadata(attendanceRecordGetCmd, LeafSpec{
		...
		Schema: LeafSchema{
			...
			Interface: &LeafInterfaceDecl{
				...
				ProductID: "attendance", RPCName: "get_user_attendance_record",
			},
...
计划打卡时间、是否休息日。间隔不超过 7 天，最多 50 人。`,
	...
	DeclareLeafMetadata(attendanceShiftListCmd, LeafSpec{
		...
		Schema: LeafSchema{
			...
			Interface: &LeafInterfaceDecl{
				Mode: "mcp", Availability: "available",
				ProductID: "attendance", RPCName: "batch_get_employee_shifts",
			},
			Selection: LeafSelectionDecl{
  ...
  dws attendance rules --date "2026-03-14 09:00:00"`,
	...
	DeclareLeafMetadata(attendanceRulesCmd, LeafSpec{
		...
		Schema: LeafSchema{
			...
			Interface: &LeafInterfaceDecl{
				Mode: "mcp", Availability: "available",
				ProductID: "attendance", RPCName: "query_attendance_group_or_rules",
			},
			Selection: LeafSelectionDecl{
