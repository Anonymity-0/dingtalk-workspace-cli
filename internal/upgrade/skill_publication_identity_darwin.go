...
// classic inode-reuse race on recycled-inode filesystems, which the
// publication fingerprint backstop still catches. An unreadable or
// unrecognizable path reports "" and callers treat that as "no witness".
