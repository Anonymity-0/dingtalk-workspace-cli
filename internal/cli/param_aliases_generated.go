...
var generatedParamAliases = []ParamAliasEntry{
	...
	},
	{
		...
		Blocked: []string{"chat-id", "chat-ids", "conversation-id", "conversation-ids", "group-id", "group-ids", "name", "title"},
	},
	{
	...
	},
	{
		...
		Blocked: []string{"block-id", "chat-id", "chat-ids", "conversation-id", "conversation-ids", "group-id", "group-ids", "name", "title"},
	},
	{
	...
	},
	{
		...
		Blocked:   []string{"before-block-id", "parent-block", "parent-block-id"},
		Ambiguous: []string{"block-id"},
	},
	{
		CLIPath:   "doc read",
		Blocked:   []string{"before-block-id", "parent-block-id", "ref-block-id", "reference-block-id"},
		Ambiguous: []string{"block-id"},
	},
	{
		CLIPath: "doc update",
		Blocked: []string{"version", "version-no", "version-number"},
	},
	{
		CLIPath: "doc version revert",
		Aliases: map[string]string{
