	...
	Constraints: append([]shortcut.Constraint{
		{
			...
			Flags:       []string{"query", "keyword", "text", "text-query", "group", "conversation-id", "id", "groups", "chat-id", "chat-query", "senders", "sender", "sender-query", "at-me", "is-at-me", "at-ids", "message-type", "only-robot", "conversation-type", "chat-type", "start", "start-time", "end", "end-time", "all-time"},
